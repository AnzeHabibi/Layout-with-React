    ...
    return (
        <div className="body-wrap">
            ...
            <main className="site-content">
                    <Section className="hero illustrasion-section-01" isCenteredContent>
          ...
          <Section className="feature-tiles">
            ...
            <div className="features-tiles-inner section-inner">
                <div className="tiles-wrap">
                  {
                    features.map((features,index) => <Feature key={index} delayInMS={index*500} data={features}></Feature> )
                  }
              </div>
              </div>
              </div>
